...
import com.jarvis.core.navigation.internal.BundleDataMap
import com.jarvis.core.navigation.internal.UriDataDecoder
import com.jarvis.core.navigation.internal.decodeArguments
...
public fun <T : Destination> decodeArguments(
    ...
    // Arguments may be empty if the destination does not have any parameters, and it is a start destination.
