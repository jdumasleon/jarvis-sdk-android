...
/**
 * Creates a [DSReorderableLazyGridState] that is remembered across compositions.
 *
 * Changes to [lazyGridState], [scrollThresholdPadding], [scrollThreshold], and [DSScroller] will result in [DSReorderableLazyGridState] being updated.
 *
...
fun rememberReorderableLazyGridState(
    ...
    val state = remember(
        scope, lazyGridState, scrollThreshold, scrollThresholdPadding, DSScroller,
    ) {
        DSReorderableLazyGridState(
            state = lazyGridState,
            scope = scope,
...
@Stable
class DSReorderableLazyGridState internal constructor(
    state: LazyGridState,
    ...
    scrollMoveMode: ScrollMoveMode,
    layoutDirection: LayoutDirection,
) : DSReorderableLazyCollectionState<LazyGridItemInfo>(
 ...
 */
@Composable
fun LazyGridItemScope.DSReorderableItem(
    state: DSReorderableLazyGridState,
    key: Any,
