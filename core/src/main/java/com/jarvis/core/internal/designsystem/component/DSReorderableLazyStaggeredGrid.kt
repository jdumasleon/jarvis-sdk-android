...
import com.jarvis.core.internal.designsystem.utils.rememberScroller
import kotlinx.coroutines.CoroutineScope

/**
 * Creates a [DSReorderableLazyStaggeredGridState] that is remembered across compositions.
 *
 * Changes to [lazyStaggeredGridState], [scrollThresholdPadding], [scrollThreshold], and [DSScroller] will result in [DSReorderableLazyStaggeredGridState] being updated.
 *
 ...
 * @param DSScroller The [DSScroller] that will be used to scroll the grid. Use [rememberScroller](sh.calvin.reorderable.ScrollerKt.rememberScroller) to create a [DSScroller].
...
fun rememberReorderableLazyStaggeredGridState(
    ...
    scrollThreshold: Dp = DSReorderableLazyCollectionDefaults.ScrollThreshold,
    DSScroller: DSScroller = rememberScroller(
...
): DSReorderableLazyStaggeredGridState {
    ...
    val state = remember(
        scope, lazyStaggeredGridState, scrollThreshold, scrollThresholdPadding, DSScroller,
    ) {
        DSReorderableLazyStaggeredGridState(
...
@Stable
class DSReorderableLazyStaggeredGridState internal constructor(
    state: LazyStaggeredGridState,
    ...
    scrollMoveMode: ScrollMoveMode,
    layoutDirection: LayoutDirection,
) : DSReorderableLazyCollectionState<LazyStaggeredGridItemInfo>(
 ...
 */
@Composable
fun LazyStaggeredGridItemScope.DSReorderableItem(
    state: DSReorderableLazyStaggeredGridState,
    key: Any,
