 ...
 */
typealias NetworkRulesUiState = ResourceState<NetworkRulesData>

/**
 * Data for Network Rules screen
 */
data class NetworkRulesData(
    ...
    companion object {
        fun empty() = NetworkRulesData()
        
        fun mockRulesData() = NetworkRulesData(
            rules = listOf(
                NetworkRule(
                    id = "1",
                    ...
                    responseModifications = com.jarvis.features.inspector.domain.entity.ResponseModifications(
                ...
                NetworkRule(
                    ...
                    mode = com.jarvis.features.inspector.domain.entity.RuleMode.MOCK,
                    responseModifications = com.jarvis.features.inspector.domain.entity.ResponseModifications(
                        statusCode = 200,
